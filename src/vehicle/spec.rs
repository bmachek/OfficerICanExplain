...
pub struct VehicleSpec {
    ...
    // --- steering ---
    pub max_steer: f32,
    /// How fast the steering angle chases the input, in 1/s, on the way
    /// *into* a turn; centring runs 1.6× this (`controller::update_steering`).
    /// Tuned twice from play: the first values (5.5–10) read as towing a
    /// caravan, the overcorrection (8–15) as twitchy enough to put cars
    /// sideways. The felt turn-in lag is roughly 2/rate to settle.
    pub steer_rate: f32,
